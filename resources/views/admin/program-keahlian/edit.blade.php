                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @if($program_keahlian->hero_image)
                                <img src="{{ img_url($program_keahlian->hero_image, 'program_keahlians', $program_keahlian->id, 'hero_image') }}" class="w-full h-32 object-cover rounded-lg mb-2">
                            @endif
                        ...
                        <div>
                            ...
                            @if($program_keahlian->overview_image)
                                <img src="{{ img_url($program_keahlian->overview_image, 'program_keahlians', $program_keahlian->id, 'overview_image') }}" class="w-full h-32 object-cover rounded-lg mb-2">
                            @endif
