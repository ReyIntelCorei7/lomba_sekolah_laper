        ...
        <div class="grid md:grid-cols-4 gap-12 mb-16">
            <div class="md:col-span-2">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ $settings['social_instagram'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 transition-all" title="Instagram">
                    ...
                    <a href="{{ $settings['social_facebook'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-blue-600 transition-all" title="Facebook">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://wa.me/{{ $settings['social_whatsapp'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-green-500 transition-all" title="WhatsApp">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_tiktok'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-black transition-all" title="TikTok">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_twitter'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-black transition-all" title="X (Twitter)">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_youtube'] }}" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-red-600 transition-all" title="YouTube">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
