                ...
                <div class="max-w-2xl mt-16 md:mt-20">
                    ...
                    <div class="flex gap-6 md:gap-8 mt-6 md:mt-8">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-[10px] md:text-xs text-gray-400 uppercase tracking-wider" x-text="$store.lang.t('about_accreditation')">Akreditasi</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
            ...
            <div class="hidden md:block space-y-4">
                ...
                <div @click="active='sejarah'"
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-bold text-gray-900" x-text="$store.lang.t('about_history_title')">Sejarah Sekolah</h3>
                    </div>
                </div>
                ...
                <div @click="active='visi'"
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-bold text-gray-900" x-text="$store.lang.t('about_vision_mission')">Visi dan Misi</h3>
                    </div>
                </div>
            ...
            <div class="md:col-span-3">
                ...
                <div x-show="active==='sejarah'"
                    ...
                    <span class="text-blue-600 font-semibold text-xs md:text-sm uppercase tracking-wider" x-text="$store.lang.t('about_history')">History</span>
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mt-2 mb-4 md:mb-6" x-text="$store.lang.t('history_metland')">Sejarah Metland School</h2>
                    ...
                    <div class="relative mb-6 md:mb-8 group">
                        ...
                        <div class="absolute bottom-3 right-3 md:bottom-4 md:right-4 bg-blue-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg shadow-lg">
                            <div class="text-base md:text-xl font-bold" x-text="$store.lang.t('history_years_established')">10+ Tahun</div>
                            <div class="text-[10px] md:text-xs opacity-80" x-text="$store.lang.t('history_established_label')">Berdiri</div>
                        </div>
                    </div>

                    <div class="prose prose-sm md:prose-lg max-w-none text-gray-700 leading-relaxed space-y-3 md:space-y-4">
                        <p class="text-sm md:text-base" x-text="$store.lang.t('history_p1')">SMK Metland berdiri pada 1 April 2014, oleh Yayasan Pendidikan Metland di kawasan perumahan Metland Transyogi, bermula dari 12 siswa pada tahun pertama dengan program studi Perhotelan.</p>

                        <p class="text-sm md:text-base" x-text="$store.lang.t('history_p2')">Pada tahun 2015 bertambah menjadi 185 siswa. SMK Metland mengembangkan program studi Akuntansi, Multimedia dan Tata Boga, dengan fasilitas gedung sekolah berlantai lima.</p>

                        <p class="text-sm md:text-base" x-text="$store.lang.t('history_p3')">SMK Metland mengalami kemajuan yang signifikan pada bulan Juli 2020, dengan jumlah siswa mencapai 659 yang terbagi dalam empat program studi. Berbagai macam penghargaan dan prestasi telah diraih baik tingkat Nasional maupun ASEAN.</p>

                        <p class="text-sm md:text-base" x-text="$store.lang.t('history_p4')">Berbekal dengan akreditasi A (unggul) yang diperoleh pada tahun 2017 dan sertifikat ISO 9001:2015 pada tahun 2019, SMK Metland terus berkembang menjadi institusi pendidikan vokasi terdepan.</p>
                    </div>

                    <!-- Achievement Badges -->
                    <div class="flex flex-wrap gap-2 md:gap-3 mt-6 md:mt-8">
                        <span class="px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white rounded-full text-xs md:text-sm font-medium" x-text="$store.lang.t('history_badge_accreditation')">✓ Akreditasi A</span>
                        <span class="px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white rounded-full text-xs md:text-sm font-medium" x-text="$store.lang.t('history_badge_iso')">✓ ISO 9001:2015</span>
                        <span class="px-3 py-1.5 md:px-4 md:py-2 bg-blue-600 text-white rounded-full text-xs md:text-sm font-medium" x-text="$store.lang.t('history_badge_lsp')">✓ LSP-P1 BNSP</span>
                    </div>
                </div>
                ...
                <div x-show="active==='visi'"
                    ...
                    <span class="text-indigo-600 font-semibold text-xs md:text-sm uppercase tracking-wider" x-text="$store.lang.t('about_vision_mission')">Vision & Mission</span>
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mt-2 mb-4 md:mb-6" x-text="$store.lang.t('vision_mission_title')">Visi dan Misi SMK Metland</h2>
                    ...
                    <div class="relative mb-6 md:mb-8 group">
                        ...
                        <div class="absolute bottom-3 right-3 md:bottom-4 md:right-4 bg-indigo-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg shadow-lg">
                            <div class="text-base md:text-xl font-bold" x-text="$store.lang.t('about_vision_mission')">Visi Misi</div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-2 mb-4">
                            <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider" x-text="$store.lang.t('about_vision')">Visi Kami</span>
                        </div>
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 md:p-6 border-l-4 border-blue-600">
                            <p class="text-base md:text-lg lg:text-xl text-gray-800 font-medium leading-relaxed" x-text="$store.lang.t('vision_content')">
                    ...
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <span class="text-blue-600 font-semibold text-sm uppercase tracking-wider" x-text="$store.lang.t('about_mission')">Misi Kami</span>
                        </div>
                        ...
                        <div class="prose prose-sm md:prose-lg max-w-none text-gray-700 leading-relaxed space-y-3 md:space-y-4">
                            <div class="flex gap-3 md:gap-4 p-3 md:p-5 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                                ...
                                <p class="text-sm md:text-base text-gray-700 leading-relaxed m-0" x-text="$store.lang.t('mission_1')">Memberikan layanan pendidikan bagi peserta didik yang berorientasi pada pengembangan knowledge, skill, dan attitude berbasis industri 4.0, serta menguatkan karakter GENERASI CINTA PRESTASI.</p>
                            </div>
                            ...
                            <div class="flex gap-3 md:gap-4 p-3 md:p-5 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                                ...
                                <p class="text-sm md:text-base text-gray-700 leading-relaxed m-0" x-text="$store.lang.t('mission_2')">Mengembangkan profesionalisme guru berdasarkan nilai-nilai METLAND SCHOOL TEACHER'S VALUE dan mampu beradaptasi dengan tuntutan industri 4.0.</p>
                            </div>
                            ...
                            <div class="flex gap-3 md:gap-4 p-3 md:p-5 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                                ...
                                <p class="text-sm md:text-base text-gray-700 leading-relaxed m-0" x-text="$store.lang.t('mission_3')">Mengembangkan jaringan kerjasama kemitraan dengan DUDI dan perguruan tinggi vokasi baik di dalam maupun di luar negeri untuk pengembangan program akademik.</p>
                            </div>
                            ...
                            <div class="flex gap-3 md:gap-4 p-3 md:p-5 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100">
                                ...
                                <p class="text-sm md:text-base text-gray-700 leading-relaxed m-0" x-text="$store.lang.t('mission_4')">Mengembangkan jaringan kerjasama dengan DUDI di dalam dan di luar negeri untuk mewujudkan zero unemployment lulusan.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="active==='nilai'"
                    ...
                    <div class="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                        ...
                        <div class="w-full md:w-2/3">
                            <span class="text-pink-600 font-semibold text-xs md:text-sm uppercase tracking-wider" x-text="$store.lang.t('about_values')">Culture</span>
                            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mt-2 mb-2" x-text="$store.lang.t('about_values_title')">Nilai Budaya Sekolah</h2>
                            <p class="text-gray-600 mb-4 md:mb-6 text-base md:text-lg" x-text="$store.lang.t('about_gcp')">Generasi Cinta Prestasi</p>
                            <div class="flex items-center gap-2 mb-4 md:mb-6">
                                <div class="w-1 h-5 md:h-6 bg-primary rounded-full"></div>
                                <p class="text-gray-600 text-base md:text-lg font-bold" x-text="$store.lang.t('value_love')">Cinta</p>
                            </div>

                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_god')">Cinta Kepada Tuhan</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_parents')">Cinta Orang Tua</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_teachers')">Cinta Kepada Guru</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_knowledge')">Cinta Ilmu Pengetahuan</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_nation')">Cinta Bangsa & Tanah Air</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_environment')">Cinta Lingkungan</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_friends')">Cinta Sahabat & Sesama</span>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                                    <span class="text-xl"></span>
                                    <span class="text-gray-700 text-sm font-medium" x-text="$store.lang.t('value_self')">Cinta Diri Sendiri</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="mt-10">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-800" x-text="$store.lang.t('achievement_title')">Prestasi</h2>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <!-- Item -->
        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_confident')">
                Percaya Diri yang Kuat
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_optimistic')">
                Riang dan Selalu Optimis
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_empathy')">
                Empati
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_healthy')">
                Sehat Jiwa dan Raga
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_resilient')">
                Tidak Mudah Menyerah dan Putus Asa
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_leader')">
                Amanah Sebagai Pemimpin
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_independent')">
                Siap Menjadi Pribadi Mandiri
            </p>
        </div>

        <div class="p-4 bg-blue-50 rounded-lg transition-colors">
            <p class="text-gray-700 font-medium" x-text="$store.lang.t('achievement_innovative')">
