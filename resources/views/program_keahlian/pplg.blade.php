...
<body>
    ...
    <div class="w-full relative bg-gray-900">
        ...
        <div class="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden z-0">
            <!-- Gambar responsif -->
            <picture>
                <source media="(min-width: 768px)" srcset="{{ asset('image/PPLG.png') }}">
                <source media="(min-width: 640px)" srcset="{{ asset('image/PPLG (1).png') }}">
                <img src="{{ asset('image/PPLG (2).png') }}"
...
Pengembangan Perangkat Lunak dan GIM
        ...
        <div
            ...
            <!-- Gambar responsif -->
            <picture>
                <source media="(min-width: 768px)" srcset="{{ asset('image/PPLG 1.png') }}">
                <source media="(min-width: 640px)" srcset="{{ asset('image/PPLG 1 (1).png') }}">
                <img src="{{ asset('image/PPLG 1 (2).png') }}"
