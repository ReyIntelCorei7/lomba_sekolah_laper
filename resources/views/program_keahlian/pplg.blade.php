...
<body x-data="{ 
    ...
    t: {
        id: {
            badge: 'Program Keahlian Teknologi',
            title1: 'Pengembangan',
            title2: 'Perangkat Lunak & Gim',
            subtitle: 'Kuasai pemrograman, web development, mobile apps, dan game development untuk menjadi developer profesional.',
            ...
            overviewDesc: 'Program PPLG SMK Metland membekali siswa dengan kemampuan pemrograman, web development, mobile apps, dan game development. Belajar dengan kurikulum industri dan praktik langsung menggunakan teknologi terkini.',
            salary: 'Gaji Developer',
            sectionBadge: 'KURIKULUM & KARIR',
            sectionTitle: 'Apa yang Akan Kamu Pelajari?',
            tabMateri: 'Materi Pembelajaran',
            tabKarir: 'Peluang Karir',
            ctaTitle: 'Siap Menjadi Developer Profesional?',
            ctaDesc: 'Bergabunglah dengan program PPLG SMK Metland dan wujudkan karirmu di dunia teknologi!',
            ctaPpdb: 'Daftar PPDB Sekarang',
            ctaOther: 'Lihat Jurusan Lain'
        },
        en: {
            badge: 'Technology Skills Program',
            title1: 'Software',
            title2: 'Development & Games',
            subtitle: 'Master programming, web development, mobile apps, and game development to become a professional developer.',
            ...
            overviewDesc: 'PPLG program at SMK Metland equips students with programming, web development, mobile apps, and game development skills. Learn with industry curriculum and hands-on practice using latest technologies.',
            ...
            ctaTitle: 'Ready to Become a Professional Developer?',
            ctaDesc: 'Join PPLG program at SMK Metland and realize your career in technology!',
...
class="bg-gray-50">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-32 text-center">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6 leading-tight">
                <span x-text="t[lang].title1">Pengembangan</span> <br class="hidden md:block">
                <span class="animated-gradient" x-text="t[lang].title2">Perangkat Lunak & Gim</span>
            </h1>
            ...
            <div class="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto">
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 md:p-6 border border-white/20">
                    <div class="text-3xl md:text-4xl font-bold text-white mb-2">6+</div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                        <span x-text="t[lang].overviewTitle">Menjadi Developer Profesional</span>
                    </h2>
                    ...
                    <div class="absolute -bottom-6 -left-6 md:-left-12 bg-white rounded-2xl shadow-xl p-4 md:p-6 border border-gray-100 pulse-glow">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-500 text-sm" x-text="t[lang].salary">Gaji Developer</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="relative py-20 overflow-hidden bg-gradient-to-br from-[#1E2188] via-blue-800 to-[#1E2188]">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center">
            <h2 class="text-3xl md:text-5xl font-bold text-white mb-6" x-text="t[lang].ctaTitle">Siap Menjadi Developer Profesional?</h2>
