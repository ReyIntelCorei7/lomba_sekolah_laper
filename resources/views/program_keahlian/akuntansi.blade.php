...
<body x-data="{ 
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-indigo-900/90 via-slate-900/80 to-slate-900/90"></div>
        </div>
        
        <!-- Floating Decorative Elements -->
        <div class="absolute top-20 left-10 w-32 h-32 rounded-full bg-indigo-500/20 blur-3xl floating"></div>
        <div class="absolute bottom-40 right-20 w-48 h-48 rounded-full bg-blue-500/20 blur-3xl floating-delay"></div>
        <div class="absolute top-1/2 left-1/4 w-20 h-20 rounded-full bg-purple-500/10 blur-2xl"></div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-32 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                <a href="/ppdb" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-indigo-700 font-bold rounded-xl hover:bg-indigo-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
    ...
    <section id="overview" class="py-20 md:py-28 bg-white">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                <!-- Left Content -->
                <div>
                    <span class="inline-block px-4 py-1.5 bg-indigo-100 text-indigo-700 text-sm font-semibold rounded-full mb-6">TENTANG PROGRAM</span>
                    <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                        Menjadi <span class="text-indigo-600">Akuntan Profesional</span> Dimulai dari Sini
                    </h2>
    ...
    <section class="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div class="text-center mb-12">
                <span class="inline-block px-4 py-1.5 bg-indigo-100 text-indigo-700 text-sm font-semibold rounded-full mb-4">KURIKULUM & KARIR</span>
            ...
            <div class="flex justify-center mb-12">
                <div class="inline-flex bg-gray-100 rounded-xl p-1.5">
                    <button @click="activeTab = 'materi'" 
                            :class="activeTab === 'materi' ? 'bg-white shadow-lg text-indigo-600' : 'text-gray-600 hover:text-gray-900'"
                            class="px-6 py-3 rounded-lg font-semibold transition-all">
                        📚 Materi Pembelajaran
                    </button>
                    <button @click="activeTab = 'karir'" 
                            :class="activeTab === 'karir' ? 'bg-white shadow-lg text-indigo-600' : 'text-gray-600 hover:text-gray-900'"
                            class="px-6 py-3 rounded-lg font-semibold transition-all">
                        💼 Peluang Karir
                    </button>
                </div>
            ...
            <div x-show="activeTab === 'materi'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Skill Card 4 -->
                    <div class="skill-card bg-white rounded-2xl p-6 border border-gray-100 shadow-lg">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center mb-4">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Skill Card 6 -->
                    <div class="skill-card bg-white rounded-2xl p-6 border border-gray-100 shadow-lg">
                        <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-rose-500 to-red-600 flex items-center justify-center mb-4">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="activeTab === 'karir'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0">
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Career Card 1 -->
                    <div class="skill-card bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-6 text-white">
                        <div class="text-4xl mb-4">💰</div>
                        <h3 class="text-xl font-bold mb-2">Staff Akuntansi</h3>
                        <p class="text-indigo-100 text-sm">Mengelola pembukuan dan laporan keuangan perusahaan</p>
                    </div>
                    ...
                    <div class="skill-card bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white">
                        ...
                        <p class="text-emerald-100 text-sm">Mengurus administrasi perpajakan perusahaan</p>
                    </div>
                    ...
                    <div class="skill-card bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl p-6 text-white">
                        ...
                        <p class="text-orange-100 text-sm">Mengelola transaksi penjualan harian</p>
                    </div>
                    ...
                    <div class="skill-card bg-gradient-to-br from-pink-500 to-rose-600 rounded-2xl p-6 text-white">
                        ...
                        <p class="text-pink-100 text-sm">Administrasi keuangan dan pembayaran</p>
                    </div>
                    
                    <!-- Career Card 6 -->
                    <div class="skill-card bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white">
                        <div class="text-4xl mb-4">🧮</div>
                        <h3 class="text-xl font-bold mb-2">Juru Penggajian</h3>
                        <p class="text-violet-100 text-sm">Menghitung dan mengelola payroll karyawan</p>
                    </div>
                    ...
                    <div class="skill-card bg-gradient-to-br from-amber-500 to-yellow-600 rounded-2xl p-6 text-white">
                        ...
                        <p class="text-amber-100 text-sm">Mengelola stok dan inventaris barang</p>
                    </div>
    ...
    <!-- CTA Section -->
    <section class="relative py-20 overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700">
        <!-- Pattern -->
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 md:px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/ppdb" class="inline-flex items-center justify-center gap-2 px-10 py-5 bg-white text-indigo-700 font-bold text-lg rounded-xl hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
