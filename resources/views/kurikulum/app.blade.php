    ...
    <div class="relative text-white min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-16 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <!-- Text Content -->
                <div class="slide-up">
                    <span class="inline-block px-4 py-2 bg-white/10 backdrop-blur rounded-full text-sm font-medium mb-6 border border-white/20 blur-fade-in-up" x-text="$store.lang.t('curriculum_badge')">
                        Kurikulum Unggulan SMK Metland
                    </span>
                    <h1 class="text-4xl md:text-6xl font-bold mb-6 leading-tight blur-fade-in-up delay-100">
                    ...
                    <p class="text-lg md:text-xl text-white max-w-xl leading-relaxed mb-8 blur-fade-in-up delay-200" x-text="$store.lang.t('curriculum_subtitle')">
                    ...
                    <div class="flex flex-wrap gap-4 blur-fade-in-up delay-300">
